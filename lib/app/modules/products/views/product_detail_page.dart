...
class _ProductDetailsViewState
  ...
  void initState() {
    ...
    userNameController3 = TextEditingController(text: '0,00');
    userNameController4 = TextEditingController(text: '0');
  }
                      ...
                      child: Row(
                        ...
                        children: [
                          Expanded(
                            child: Padding(
                              padding:
                                  EdgeInsetsDirectional.fromSTEB(0, 16, 8, 12),
                              child: TextFormField(
                          ...
                          Expanded(
                            child: Padding(
                              padding:
                                  EdgeInsetsDirectional.fromSTEB(8, 16, 0, 12),
                              child: TextFormField(
                                controller: userNameController4,
                                obscureText: false,
                                decoration: InputDecoration(
